...
from app.features.models.service import (
    discover_models,
...
from app.model_settings import get_model_settings, settings_to_dict
from app.observability import audit_event
from app.schemas import ModelRegistrationRequest, ModelSettingsRequest
