...
Converts browser microphone audio to 24 kHz PCM16 and proxies it through FastAPI to a selected `gpt-realtime-whisper` or `gpt-live-transcribe` Realtime WebSocket session.
