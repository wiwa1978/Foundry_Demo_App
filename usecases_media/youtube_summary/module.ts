...
export const youtubeSummaryUseCase: UseCaseModule = {
  ...
  implementation: [
    ...
    "Available creator or auto-generated captions are used first; unavailable captions trigger a bounded audio download and transcription fallback.",
