...
Write-Host "  RESOURCE_GROUP_NAME=RG-AI-DEMO-APP1"
Write-Host "  SHARED_RESOURCE_GROUP_NAME=RG-AI-DEMO"
Write-Host "  CONTAINER_REGISTRY_NAME=acr66fb"
Write-Host "  CONTAINER_APP_NAME=ca-foundry-chat"
Write-Host "  CONTAINER_APPS_ENV_ID=/subscriptions/$SubscriptionId/resourceGroups/RG-AI-DEMO/providers/Microsoft.App/managedEnvironments/cae-ai-demo"
