...
| `AZURE_SPEECH_ENDPOINT` | Azure AI Speech custom-domain endpoint for Recorded Audio Transcription, Live translation, and the standalone Azure Speech Text to Speech use case. |
