...
import { Copy, Download, LoaderCircle, Mic, MicOff, UploadCloud, Volume2 } from "lucide-react";
...
export function SidebarPipelineSelect({ label, value, models, onChange, disabled }: { label: string; value: string; models: string[]; onChange: (model: string) => void; disabled: boolean }) {
